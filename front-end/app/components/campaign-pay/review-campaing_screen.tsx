      ...
      <div className="bg-gradient-to-r from-blue-500 to-purple-600 px-6 py-4">
        <div className="flex justify-between items-center mb-4">
          <div className="flex items-center">
            ...
            <span className="text-white font-bold text-xl">InfluNest</span>
          </div>
        </div>
        <div className="text-center">
          <h2 className="text-white text-lg font-medium mb-2">Campaign: {campaignData.name}</h2>
          <p className="text-white text-sm opacity-90">Secure payment via Base blockchain</p>
        </div>
      </div>
              ...
              <div className="flex-1">
                ...
                {campaignData.influencer.verified && (
                  <div className="flex items-center">
                    ...
                    <span className="text-green-600 text-sm font-medium">Verified by InfluNest</span>
                  </div>
                )}
              </div>
            </div>
          ...
          {!isConnected ? (
            <Wallet className="w-full">
              <ConnectWallet className="w-full">
                <Button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-4 rounded-xl font-bold text-lg flex items-center justify-center shadow-lg">
                  <Icon name="wallet" className="mr-3" size="md" />
                  Connect Wallet
                </Button>
              </ConnectWallet>
            </Wallet>
